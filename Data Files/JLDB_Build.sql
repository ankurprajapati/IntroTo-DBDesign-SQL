...
SELECT NAME AS "Publisher's Name", CONTACT, PHONE FROM PUBLISHER ;
...
SELECT ORDER# , ITEM#, ISBN, QUANTITY, PAIDEACH, QUANTITY*PAIDEACH ITEMTOTAL 
FROM ORDERITEMS;

CREATE TABLE CATEGORY
(CatCode VARCHAR(2) PRIMARY KEY,
CatDesc VARCHAR2(10)  NOT NULL);

DESC CATEGORY;

CREATE TABLE EMPLOYEES 
(Emp# NUMBER(5,0), Lastname VARCHAR2(10) NOT NULL, Firstname VARCHAR2(10) NOT NULL, Job_class CHAR(4) NOT NULL);

DESC EMPLOYEES;

ALTER TABLE EMPLOYEES ADD (EmpDate Date DEFAULT SYSDATE, EndDate DATE); 

ALTER TABLE EMPLOYEES MODIFY job_class VARCHAR2(2); DESC EMPLOYEES;

ALTER TABLE EMPLOYEES DROP COLUMN EndDate; DESC EMPLOYEES;
...
ALTER TABLE store_reps( last VARCHAR2(15) NOT NULL,
  first VARCHAR2(10) NOT NULL,);
  
ALTER TABLE store_reps
MODIFY first VARCHAR2(10) NOT NULL;

ALTER TABLE store_reps ADD CONSTRAINT comm_ck CHECK (comm IN ('Y','N'));

ALTER TABLE store_reps ADD base_salary NUMBER(7,2) CHECK(base_salary>=0);

CREATE TABLE BOOK_STORES(Store_ID NUMBER(8) PRIMARY KEY, Name VARCHAR2(30) NOT NULL, Contact VARCHAR2(30), Rep_ID VARCHAR2(5), UNIQUE(Name));
DESC BOOK_STORES;
